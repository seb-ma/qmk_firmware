...
For example, in these implementations, [Combos](#Combos) and [Leader key](#Leader-key) are nearly equivalents. Choice is a matter of taste; but using specific compilation for each halve will help a lot (see [Compilation and flashing](#Compilation-and-flashing) for details).
...
1. [Layers](#Layers)
    ...
    1. [Base layer (alphas)](#Base-alphabetic)
    1. [Numerics / Symbols / Functions](#Numeric--Symbols)
    1. [Navigation / Mouse](#Navigation--Mouse)
    1. [Shortcuts](#Shortcuts)
    1. [Media / RGB](#Media--RGB)
1. [Encoders](#Encoders)
    1. [Left encoder](#Left-encoder)
    1. [Right encoder](#Right-encoder)
1. [Special features](#Special-features)
    1. [Close char](#Close-Char)
    1. [Pomodoro](#Pomodoro)
    1. [Custom transport](#Custom-transport)
1. [Features](#Features)
    1. [Custom keys](#Custom-keys)
    1. [Combos](#Combos)
    1. [Dynamic macros](#Dynamic-macros)
    1. [HID](#HID)
    1. [Leader key](#Leader-key)
    1. [Tap dance](#Tap-dance)
    1. [Unicode](#Unicode)
1. [Display](#Display)
    1. [Font](#Font)
    1. [Master screen](#Master-screen)
    1. [Follower screen](#Follower-screen)
1. [RGB](#RGB)
    1. [LED positions](#LED-positions)
    1. [RGB modes](#RGB-modes)
1. [Sources and compilation](#Sources-and-compilation)
    1. [Code organization](#Code-organization)
    1. [Memory footprint](#Memory-footprint)
    1. [Compilation and flashing](#Compilation-and-flashing)
1. [Useful documentation and tools](#Useful-documentation-and-tools)
    1. [QMK documentation](#QMK-documentation-and-tools)
...
- the same layout for thumbs, except:
  - on Navigation / Mouse layer for left thumb (mouse button)
  - on Media layer for encoders
...
Behavior is identical in all layers except in [Media / RGB](#Media--RGB)
...
- key `Num Symb`: hold to temporary access or tap to enter/exit [Numeric / Symbols / Functions](#Numeric--Symbols) layer
- key `Nav Mouse`: hold to temporary access or tap to enter/exit [Navigation / Mouse](#Navigation--Mouse) layer
- keys `Num Symb` + `Nav Mouse`: hold to temporary access or tap to enter/exit [Media / RGB](#Media--RGB) layer
...
|Code|Description|
|---|---|
|CloseChar|Automatically close opened chars `"(«[{` (see [Close char](#Close-Char) feature for details)|
...
![keyboard-layout-editor - Navigation / Mouse](https://i.imgur.com/PwekOzW.png)
[keyboard-layout-editor - Navigation / Mouse](http://www.keyboard-layout-editor.com/##@_backcolor=%23ffffff&name=Kyria%3B&@_x:18.75&c=%23f1f1f1&fa@:1&:1&:1&:1%3B%3B&=Shift%0Akey%0AAltGr%20Shift%0AAltGr%0Ahold%3B&@_y:-0.75&x:3&c=%23add1ad&p=R1&fa@:1&:0&:1&:1&:0&:0&:0&:0&:0&:1%3B%3B&=%0A%3Ci%20class%2F='kb%20kb-Unicode-Page-Down-3'%3E%3C%2F%2Fi%3E%0A%0A%0A%0A%0A%0A%0A%0A%3Ci%20class%2F='fa%20fa-mouse-pointer'%3E%3C%2F%2Fi%3E&_x:9&c=%23cccccc%3B&=%0A%3Ci%20class%2F='kb%20kb-Unicode-Page-Down-3'%3E%3C%2F%2Fi%3E%3B&@_y:-0.75&x:2&c=%23add1ad%3B&=%0A%3Ci%20class%2F='kb%20kb-Unicode-Page-Up-3'%3E%3C%2F%2Fi%3E%0A%0A%0A%0A%0A%0A%0A%0A%3Ci%20class%2F='fa%20fa-mouse-pointer'%3E%3C%2F%2Fi%3E&_x:1%3B&=%0A%3Ci%20class%2F='kb%20kb-Line-End'%3E%3C%2F%2Fi%3E%0A%0A%0A%0A%0A%0A%0A%0A%3Ci%20class%2F='fa%20fa-mouse-pointer'%3E%3C%2F%2Fi%3E&_x:7&c=%23cccccc%3B&=%0A%3Ci%20class%2F='kb%20kb-Line-Start'%3E%3C%2F%2Fi%3E&_x:1%3B&=%0A%3Ci%20class%2F='kb%20kb-Unicode-Page-Up-3'%3E%3C%2F%2Fi%3E%3B&@_y:-0.875&x:5&c=%23add1ad%3B&=%0ABtn%203%0A%0A%0A%0A%0A%0A%0A%0A%3Ci%20class%2F='fa%20fa-mouse-pointer'%3E%3C%2F%2Fi%3E&_x
%3E%3C%2F%2Fi%3E%0A%3Ci%20class%2F='kb%20kb-Line-End'%3E%3C%2F%2Fi%3E%0A%3Ci%20class%2F='kb%20kb-Arrows-Right'%3E%3C%2F%2Fi%3E%0A%0A%0A%0A%0A%0A%3Ci%20class%2F='kb%20kb-Hamburger-Menu'%3E%3C%2F%2Fi%3E%3B&@_rx:4&ry:8.175&y:-4.675&x:-0.5&c=%23018aaa&a:7%3B&=Alt%3B&@_rx:13&y:-5.925000000000001&x:5.75&fa@:2%3B%3B&=Modifier%3B&@_y:0.2500000000000009&x:-0.5&f:3%3B&=Ctrl%3B&@_r:15&rx:4&y:-4.675&x:-0.5&c=%2350ab6f&f:3%3B&=Num%20Symb%3B&@_r:30&y:-2&x:-0.5&c=%23018aaa&f:3%3B&=Ctrl%3B&@_x:-0.5&c=%235395ac&a:4&fa@:1&:0&:1&:0&:0&:0&:0&:0&:0&:0%3B&n:true%3B&=nb%2F&%239251%2F%3B%0A%2F&%239251%2F%3B%0Annb%2F&%239251%2F%3B%0A%2F_%0A%E2%87%A7%3B&@_r:45&y:-2&x:-0.5&c=%23cccccc%3B&=%0A%3Ci%20class%2F='mss%20mss-Unicode-BackSpace-DeleteLeft-Big-2'%3E%3C%2F%2Fi%3E%3B&@_x:-0.5&c=%2350ab6f%3B&=%0A%3Ci%20class%2F='kb%20kb-Tab-1'%3E%3C%2F%2Fi%3E%0A%0A%0AShorcuts%3B&@_r:-45&rx:13&y:-5.675&x:-0.5&c=%23cccccc%3B&=%0ADel%3B&@_x:-0.5&c=%23018aaa&a:7&f:3%3B&=Alt%3B&@_r:-30&y:-2&x:-0.5&f:3%3B&=%E2%87%A7%3B&@_x:-0.5&c=%235395ac&a:4&n:true%3B&=%0A%3Ci%20class%2F='kb%20kb-Return-2'%3E%3C%2F%2Fi%3E%0A%0A%0AAltGr%3B&@_r:-15&y:-1&x:-0.5&c=%2350ab6f&a:7&f:3%3B&=Nav%20Mouse)
...
|Start/Stop pomodoro<sup>1</sup>|Start (or stop) a timer of 25 minutes|
|Reset EEPROM|Reinitialize data stored in EEPROM (user configuration, RGB…)|

*<sup>1</sup>: Warn: works only with the implementation of [Custom transport](#Custom-transport) between halves*
...
|---|---|
|tap|GUI|
|clockwise|mouse wheel down|
|reverse clockwise|mouse wheel up|
|AltGr + clockwise|page down|
|AltGr + reverse clockwise|pahe up|
...
This feature can be upgraded with a [special animation](#Pomodoro-animation).
...
|Code|Description|
|---|---|
|C_CLOSE_CHAR|Close lasts opening chars *See [Close Char feature](#Close-Char)*|
|C_CLOSE_CHAR_CLEAR|Clear buffer of [Close Char feature](#Close-Char)|
...
|---|---|---|
|`ga`|git add|`git add .`|
|`gd`|git diff staged|`git diff --staged`|
|`gl`|git log|`git log`|
|`glo`|git log online|`git log --oneline`|
|`gf`|git fetch|`git fetch`|
|`go`|git checkout|`git checkout`|
|`gp`|git pull|`git pull`|
|`gs`|git status|`git status`|
|`gc`|git commit with comment|`git commit -m ''`|
...
!> The cycle can only work with [Custom transport](#Custom-transport) enabled.
...
It needs to have following activated features to work: [Pomodoro](#Pomodoro) and [Custom transport](#Custom-transport) data between halves.
...
See [Compilation and flashing](#Compilation-and-flashing) for how to compile a specific halve.
